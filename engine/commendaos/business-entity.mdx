...
| `startDate` | string | Start date of the relationship (YYYY-MM-DD) |
| `endDate` | string \| null | End date, or `null` if current |
| `ownershipPercentage` | number | Ownership share as a percentage |
| `isResidentDirector` | boolean | Optional. Whether this person is a resident director of the entity |
