...
- **Philippines**: SEC (Securities and Exchange Commission) registration
...
- **Philippines**: BIR Tax Identification Number (TIN)
...
- **Philippines**: BIR VAT registration
...
- **Philippines**: BIR employer withholding registration
...
- **UAE**: Trade license
- **Philippines**: Mayor's / Business Permit, Barangay Clearance
