...
Only `blocks[].fields[]` keys are valid intake keys. Participant resource fields from `resourceFieldsByParticipantType` must be written to the referenced Commenda OS resource.
