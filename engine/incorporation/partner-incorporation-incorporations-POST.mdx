...
New incorporations are returned with `incorporationStatus: "collecting_information"` until required intake data, participant roles, and documents validate. Once the current incorporation state is complete, the status becomes `ready_for_review`.
