...
New incorporations are returned with `incorporationStatus: "collecting_information"`. Once required intake data, participant roles, and documents validate, call `POST /partner/incorporation/{incorporationId}/submit`; after submit succeeds, the status becomes `ready_for_review`.
