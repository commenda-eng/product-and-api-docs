...
Use this endpoint to refresh the latest `intakeState`, `incorporationValidation`, participants, and top-level `incorporationStatus` for an ongoing incorporation.
