...
| `recommended_registration_content_ids` | Array of V2 registration content IDs recommended for this jurisdiction (e.g., `["REG_STATE_CEN_06"]`). A jurisdiction may have more than one recommendation (for example, OSS and a local scheme). Use these with the [V2 Registration API](/engine/indirect-tax/registrations/v2/registrations-v2) to create a registration. |
