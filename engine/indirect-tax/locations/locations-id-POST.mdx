...
<ParamField body="metadata" type="object">
  Caller-supplied JSON object stored verbatim alongside the location. Pass the full object to update — values are not deep-merged.
</ParamField>
...
curl --request POST \
  ...
  --data '{
    "location_types": ["PRINCIPAL_PLACE_OF_BUSINESS", "REGISTERED_OFFICE", "WAREHOUSE"],
