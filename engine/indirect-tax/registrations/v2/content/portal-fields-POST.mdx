    ...
    "portals": [
      {
        ...
        "credential_fields": [
          ...
          },
          {
            ...
            "is_unique_per_registration": false,
            "display_order": 2,
            "helper_text": "Enter the password associated with your CDTFA account."
          }
        ]
      }
    ]
...
| `helper_text` | string | Instructional text to display alongside the field in a UI (if applicable) |
