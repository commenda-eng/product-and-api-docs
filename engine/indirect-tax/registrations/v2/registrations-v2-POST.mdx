...
<ParamField body="frequencies" type="array">
  Array of filing frequencies. Must exactly match one of the allowed frequency combinations from the content response. Can be omitted when the filing frequency is not yet known at registration time.
