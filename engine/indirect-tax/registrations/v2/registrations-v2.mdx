...
<Note>
  The `member_state_registration_id` must reference an active domestic registration in an EU country where your business has a qualifying establishment (principal place of business, branch office, warehouse, factory, retail location, or dependent agent).
</Note>
