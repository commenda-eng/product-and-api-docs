...
You can enable Commenda-managed filing on a registration by setting `managed_filing_enabled` to `true` when [updating](/engine/indirect-tax/registrations/v2/registrations-v2-id-POST) it. When managed filing is enabled, Commenda handles the filing process on your behalf for that jurisdiction.
...
| [`/registrations/v2/content/jurisdictions`](/engine/indirect-tax/registrations/v2/content/available-jurisdictions-POST) | GET | Search for available jurisdictions |
...
| [`/registrations/v2`](/engine/indirect-tax/registrations/v2/registrations-v2-GET) | GET | List registrations with filters |
...
| Endpoint | Method | Description |
|----------|--------|-------------|
| [`/registrations/v2/bulk`](/engine/indirect-tax/registrations/v2/registrations-v2-bulk-POST) | POST | Create multiple registrations at once |
| [`/registrations/v2/bulk/request-validation`](/engine/indirect-tax/registrations/v2/registrations-v2-bulk-request-validation-POST) | POST | Request validation for multiple registrations |
| [`/registrations/v2/bulk/registration-status`](/engine/indirect-tax/registrations/v2/registrations-v2-bulk-registration-status-POST) | POST | Update status for multiple registrations |

### Tasks and form data

| Endpoint | Method | Description |
|----------|--------|-------------|
| [`/registrations/v2/tasks`](/engine/indirect-tax/registrations/v2/registrations-v2-tasks-GET) | GET | Get registration tasks for a corporation |
| [`/registrations/v2/{id}/form-data`](/engine/indirect-tax/registrations/v2/registrations-v2-id-form-data-GET) | GET | Get form data for a registration |
| [`/registrations/v2/{id}/form-data`](/engine/indirect-tax/registrations/v2/registrations-v2-id-form-data-POST) | POST | Update form data for a registration |
