...
| customer_business_identification_number | false | string | The customer's business identification number (such as a VAT ID, EIN, or GST number) associated with this transaction. |
