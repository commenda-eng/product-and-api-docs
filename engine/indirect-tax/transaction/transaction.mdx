...
<Note>
Purchase transactions do not affect sales-focused flows like nexus tracking, filing calculations, or daily sales summaries. They are stored separately for input credit calculations.
</Note>
