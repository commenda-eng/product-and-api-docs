...
**Workflows and forms**
- "Create a new workflow template named 'Customer onboarding' for company 1"
- "List all draft workflow template versions for template abc-123"
- "Publish workflow template version xyz-456"
- "Create a form template called 'Tax intake' under the 'tax-intake' key"
- "List all LIVE form templates"
- "Publish form template abc-123"
