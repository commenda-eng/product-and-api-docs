...
description: "A step-by-step guide to configuring sales tax compliance in Commenda."
keywords: ["sales tax setup", "tax compliance", "tax registration", "nexus"]
---

This guide walks you through setting up sales tax management for your entities in Commenda.

## Prerequisites

- At least one entity added to your Commenda account
- Business information filled in for the entity (EIN, addresses)
- Knowledge of where you have sales tax nexus

## Step 1: Navigate to sales tax

Click **Sales Tax** in the sidebar. If you have multiple entities, select the entity you want to configure.

## Step 2: Complete the onboarding flow

The first time you access sales tax for an entity, you'll go through a brief setup:
...
Add each state or jurisdiction where you're registered for sales tax:
...
1. Click the integration option in your sales tax settings.
...
<Tip>
After initial setup, check the Sales Tax section weekly to review new transactions and upcoming filing deadlines.
</Tip>
