...
<Steps>
  <Step title="Generate a connection link">
    From your Commenda dashboard, navigate to the entity you want to connect. Look for the **Connect accounting software** option in your Sales Tax or entity settings. Select the platform you want to connect — Commenda generates a secure invite link.
  </Step>
