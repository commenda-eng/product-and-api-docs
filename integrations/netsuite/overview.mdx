...
<Card title="NetSuite Plugin Checklist" icon="list-check" href="/integrations/netsuite/plugin-checklist">
Before going live, run through the plugin checklist to verify the bundle is set up correctly. Repeat it after any bundle update or new state registration.
</Card>
...
- [NetSuite Plugin Checklist](/integrations/netsuite/plugin-checklist)
