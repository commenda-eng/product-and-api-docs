...
- **Country-specific fields** — additional fields that vary by country (for example, IFSC code for India, IBAN for European countries, sort code for the UK, or BSB code for Australia)

<Tip>
The form automatically shows the correct fields for the selected country. Double-check your account and routing numbers before saving — incorrect numbers can cause payment failures.
</Tip>
...
- **Edit account details** — update bank name, account holder name, account type, currency, country-specific credentials, or primary status
