---
title: "Transactions"
description: "Import and manage taxable transactions for sales tax compliance."
keywords: ["transactions", "sales data", "tax transactions", "CSV upload"]
---

The **Transactions** tab shows all your taxable transactions, which feed into your sales tax filings and calculations.
...
Go to **Sales Tax** and select an entity, then click the **Transactions** tab. Each transaction shows:
